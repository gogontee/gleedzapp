  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="md:hidden">
        {/* Static Poster - Fixed at the top, takes 40% of screen */}
        <div className="fixed top-0 left-0 w-full h-[40vh] z-10">
          <PosterShowcaseMobile />
        </div>
        
        {/* Login Form Container - Starts below poster, scrolls under it */}
        <div className="relative z-0 pt-[40vh] min-h-screen bg-white">
      ...
      <div className="hidden md:flex min-h-screen">
        {/* Poster Section - Fixed on desktop */}
        <div className="w-[480px] fixed left-0 top-0 h-full">
          <PosterShowcase />
        </div>
        
        {/* Login Section - Offset for fixed poster */}
        <div className="flex-1 ml-[480px] min-h-screen flex justify-center items-center px-6 py-12 bg-white">
          <motion.div
