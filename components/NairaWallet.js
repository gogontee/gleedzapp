...
export default function NairaWallet() {
  ...
  const exportToCSV = () => {
    ...
    link.href = url;
    link.download = `naira-transactions-${new Date().toISOString().split('T')[0]}.csv`;
    link.click();
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-4 px-2 sm:px-4">
      ...
      <div className="flex justify-between items-center">
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Naira Wallet</h1>
        <button
          onClick={refreshData}
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-red-600 text-xs">Please sign in to view your Naira Wallet</p>
            </div>
          </div>
        </div>
      ) : (
