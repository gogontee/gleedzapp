...
export default function CandidateGallery({ gallery, pageColor, onMediaClick }) {
      ...
      <div className="relative bg-white rounded-2xl shadow-lg p-4 border border-gray-100 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-70">
          <Image
            ...
            unoptimized
            priority // FIX: Added priority for LCP image
          />
        </div>
  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-lg p-4 border border-gray-200 overflow-hidden">
      {/* Background Image */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-3">
          {gallery.map((item, index) => (
            <motion.div
              ...
              className="relative aspect-square rounded-xl overflow-hidden cursor-pointer group bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-500 border-2 border-white"
            ...
            >
              {isVideoFile(item.url || item) ? (
                ...
                <Image
                  ...
                  unoptimized
                  // FIX: For gallery thumbnails, don't use priority as they're not LCP
                />
              )}
